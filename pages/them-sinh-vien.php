  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      else
      {
        ...
        // insert data
        $insert = "INSERT INTO nhanvien(ma_nv, hinh_anh, ten_nv, biet_danh, gioi_tinh, ngay_sinh, noi_sinh, hon_nhan_id, so_cmnd, noi_cap_cmnd, ngay_cap_cmnd, nguyen_quan, quoc_tich_id, ton_giao_id, dan_toc_id, ho_khau, tam_tru, loai_nv_id, trinh_do_id, chuyen_mon_id, bang_cap_id, phong_ban_id, chuc_vu_id, trang_thai, nguoi_tao_id, ngay_tao, nguoi_sua_id, ngay_sua, ma_sinhvien) VALUES('$maNhanVien', '$hinhAnh', '$tenNhanVien', '$bietDanh', '$gioiTinh', '$ngaySinh', '$noiSinh', '$honNhan', '$CMND', '$noiCap', '$ngayCap', '$nguyenQuan', '$quocTich', '$tonGiao', '$danToc', '$hoKhau', '$tamTru', '$loaiNhanVien', '$trinhDo', '$chuyenMon', '$bangCap', '$phongBan', '$chucVu', '$trangThai', '$id_user', '$ngayTao', '$id_user', '$ngayTao', '$maSinhVien')";
        $result = mysqli_query($conn, $insert);
        if($result)
        {
          $success['success'] = 'Thêm sinh viên thành công';
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Chính sách sinh viên <span style="color: red;">*</span> : </label>
                      <select class="form-control" name="loaiNhanVien">
                      <option value="chon">--- Chọn chính sách sinh viên ---</option>
                      <?php 
