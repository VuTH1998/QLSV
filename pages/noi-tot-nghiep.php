...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['edit']))
  {
    ...
    echo "<script>location.href='sua-noi-tot-nghiep.php?p=staff&a=certificate&id=".$id."'</script>";
  }
  ...
  if(isset($_POST['save']))
  {
    ...
    if(empty($certificateName))
      $error['certificateName'] = 'Vui lòng nhập <b> tên trường tốt nghiệp </b>';
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        $success['success'] = 'Thêm trường tốt nghiệp thành công';
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Bạn có thực sự muốn xóa trường tốt nghiệp này?
          </div>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Thêm trường tốt nghiệp</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Mã trường tốt nghiệp: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="speacialCode" value="<?php echo $certificateCode; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tên trường tốt nghiệp: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên trường tốt nghiệp" name="certificateName">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Thêm trường tốt nghiệp</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Danh sách trường tốt nghiệp</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
