...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_POST['idType'];
    echo "<script>location.href='sua-chinh-sach.php?p=staff&a=employee-type&id=".$id."'</script>";
  }
  ...
  if(isset($_POST['save']))
  {
    ...
    // validate
    if(empty($typeName))
      $error['typeName'] = 'Vui lòng nhập <b> chính sánh sinh viên </b>';
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        $success['success'] = 'Tạo chính sánh sinh viên thành công';
        echo '<script>setTimeout("window.location=\'chinh-sach.php?p=staff&a=employee-type\'",1000);</script>';
      }
    }
  }
  ...
  if(isset($_POST['delete']))
  {
    ...
    if($result)
    {
      $success['success'] = 'Xóa chính sánh sinh viên thành công.';
      echo '<script>setTimeout("window.location=\'chinh-sach.php?p=staff&a=employee-type\'",1000);</script>';
    }
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Bạn có thực sự muốn xóa năm này?
          </div>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tạo chính sách sinh viên</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Mã chính sánh: </label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên chính sách" name="typeName">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Tạo chính sánh sinh viên</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Danh sách chính sách sinh viên</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
