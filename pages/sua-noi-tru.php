  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        ...
        echo '<script>setTimeout("window.location=\'sua-noi-tru.php?p=collaborate&a=add-collaborate&id='.$id.'\'",1000);</script>';
      }
    }
  }
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="maCongTac" value="<?php echo $rowAct['ma_noi_tru']; ?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Địa điểm nội trú<span style="color: red;">*</span>: </label>
