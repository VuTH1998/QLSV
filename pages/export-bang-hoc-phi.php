<?php 
	...
	// PHPExcel
  	...
  	$sheet->setCellValue('E' . $rowCount, 'Học phí kỳ');
  	$sheet->setCellValue('F' . $rowCount, 'Số tín chỉ');
	$sheet->setCellValue('G' . $rowCount, 'Đã đóng');  
  	$sheet->setCellValue('G' . $rowCount, 'Còn nợ');
  	$sheet->setCellValue('H' . $rowCount, 'Ngày dóng');
  	...
  	while ($row = mysqli_fetch_array($result)) 
  	{
		  ...
		  $sheet->setCellValue('E' . $rowCount, number_format($row['tam_ung'])."vnđ");
