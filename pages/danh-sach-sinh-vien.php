      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="them-sinh-vien.php?p=staff&a=add-staff" class="small-box-footer">
              Nhấn vào thêm sinh viên mới <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="export-sinh-vien.php" class="small-box-footer">
