  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        ...
        echo '<script>setTimeout("window.location=\'sua-ngoai-tru.php?p=collaborate&a=add-collaborate&id='.$id.'\'",1000);</script>';
      }
    }
  }
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Địa điểm ngoại trú<span style="color: red;">*</span>: </label>
