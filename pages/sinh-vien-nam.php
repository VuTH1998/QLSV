...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_POST['idLevel'];
    echo "<script>location.href='sua-nam.php?p=staff&a=level&id=".$id."'</script>";
  }
  ...
  if(isset($_POST['save']))
  {
    ...
    // validate
    if(empty($titleLevel))
      $error['titleLevel'] = 'Vui lòng nhập <b> tên sinh viên năm </b>';
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Bạn có thực sự muốn xóa sinh viên năm này?
          </div>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Thêm sinh viên năm</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Mã sinh viên năm: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="positionCode" value="<?php echo $levelCode; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tên sinh viên năm: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên sinh viên năm" name="titleLevel">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Thêm sinh viên năm</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Danh sách sinh viên năm</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>STT</th>
                    <th>Mã sinh viên năm</th>
                    <th>Tên sinh viên năm</th>
                    <th>Mô tả</th>
                    <th>Người tạo</th>
                    <th>Ngày tạo</th>
                    <th>Người sửa</th>
