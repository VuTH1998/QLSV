...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  // show data
  $NV = "SELECT id, ma_sinhvien,ho_sv, ten_sv FROM sinhvien";
  ...
  if(isset($_POST['save']))
  {
    ...
    $check = "SELECT sinhvien_id FROM ngoai_tru WHERE sinhvien_id = '$maNhanVien'";
    $resultCheck = mysqli_query($conn, $check);
    if(mysqli_num_rows($resultCheck) != 0)
    {
      $error['dangCongTac'] = 'error';
      echo "<script>alert('sinh viên này đang trong quá trình ngoại trú');</script>";
    }
    ...
    {
      $showMess = true;
      $insert = "INSERT INTO ngoai_tru(ma_ngoai_tru, sinhvien_id, ngay_bat_dau, ngay_ket_thuc, dia_diem, muc_dich, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua ) VALUES('$maCongTac','$maNhanVien', '$ngayBatDau', '$ngayKetThuc', '$diaDiem', '$mucDich', '$ghiChu', '$nguoiTao', '$ngayTao','$nguoiTao', '$ngayTao')";
      echo $insert;
      $result = mysqli_query($conn, $insert);
      if($result)
      {
        $success['success'] = 'Thêm ngoại trú thành công';
        echo '<script>setTimeout("window.location=\'ngoai-tru.php?p=collaborate&a=add-collaborate\'",1000);</script>';
      }
    }
  }
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Thêm ngoại trú</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Mã nội ngoại trú: </label>
                    ...
                    <div class="form-group">
                      ...
                      <small style="color: red;"><?php if(isset($error['diaDiem'])){ echo 'Vui lòng nhập địa điểm ngoại trú';} ?></small>
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Thêm ngoại trú</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
