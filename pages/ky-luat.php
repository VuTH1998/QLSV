...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['taoKyLuat']))
  {
    ...
    if(empty($soTienPhat))
      $error['soTienPhat'] = 'Vui lòng nhập <b> số ngày </b>';
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <a href="ky-luat.php?p=bonus-discipline&a=discipline&ky-luat" class="btn btn-app">
                <i class="fa fa-user"></i> Kỷ luật sinh viên
              </a>
              <?php 
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Kỷ luật sinh viên</h3>
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
              </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="hinhThuc">
                        ...
                        <option value="1">Đình chỉ thôi học</option>
                        <option value="0">Lập hội đồng kỷ luật</option>
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Số ngày buộc thôi học: <span style="color: red;">*</span>: </label>
