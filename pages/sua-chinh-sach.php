...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    // validate
    if(empty($typeName))
      $error['typeName'] = 'Vui lòng nhập <b> chính sách sinh viên </b>';
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        ...
        echo '<script>setTimeout("window.location=\'sua-chinh-sach.php?p=staff&a=employee-type&id='.$id.'\'",1000);</script>';
      }
    }
  }
  ...
  if(isset($_POST['delete']))
  {
    ...
    if($result)
    {
      $success['success'] = 'Xóa chính sách sinh viên thành công.';
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Bạn có thực sự muốn xóa chính sách sinh viên này?
          </div>
