...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  $kt = "SELECT ktkl.id as id, ma_kt, ten_khen_thuong, ten_sv, so_qd, ngay_qd, ten_loai, hinh_thuc, so_tien, ktkl.ngay_tao as ngay_tao FROM khen_thuong_ky_luat ktkl, sinhvien nv, loai_khen_thuong_ky_luat lktkl WHERE ktkl.sinhvien_id = nv.id AND ktkl.loai_kt_id = lktkl.id AND ktkl.flag = 1 ORDER BY ktkl.ngay_tao DESC";
  ...
  if(isset($_POST['taoKhenThuong']))
  {
    ...
    if($nhanVien == 'chon')
      $error['nhanVien'] = 'Vui lòng chọn <b> sinh viên </b>';
    ...
    {
      $showMess = true;
      $insert = "INSERT INTO khen_thuong_ky_luat(ma_kt, so_qd, ngay_qd, sinhvien_id, ten_khen_thuong, loai_kt_id, hinh_thuc, so_tien, flag, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua) VALUES('$maKhenThuong', '$soQuyetDinh', '$ngayQuyetDinh', '$nhanVien', '$tenKhenThuong', '$loaiKhenThuong', '$hinhThuc', '$soTienThuong', '$flag', '$moTa', '$nguoiTao', '$ngayTao', '$nguoiTao', '$ngayTao')";
      $result = mysqli_query($conn, $insert);
      if($result)
      {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Khen thưởng sinh viên</li>
      </ol>
    </section>
